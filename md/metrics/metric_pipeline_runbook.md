...
## 7) Chạy Gemini judge theo batch để tránh quota
...
### 7.1 Specific QA: chạy từng batch
...
### 7.2 Abstract QA: chạy từng batch
...
### 7.4 Ba mức chạy nhanh để copy-paste
...
## 10) Nếu muốn chấm LLM judge sau này
